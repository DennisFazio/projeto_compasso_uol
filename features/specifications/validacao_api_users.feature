      ...
      Cenario: validar se a API está retornando o código 200 e os dados corretos
      Quando quando realizado um get para api users sem passar parametros
      E realizo um get para o endpoint posts com o primeiro ID User retornado do get anterior
      Então devo validar se o statuscode retornou 200
