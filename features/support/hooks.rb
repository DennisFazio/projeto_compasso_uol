...
at_exit do
  ReportBuilder.configure do |config|
    ...
    config.report_path = "logs/html/Automacao_Dennis_Fazio_CompassoUOL"
    config.report_types = %i[html]
    config.report_tabs = %w[Overview Features Scenarios Errors]
    config.report_title = "Projeto de Automacao Dennis Fazio Compasso UOL"
    config.compress_images = false
    config.additional_info = {
      "Projeto:" => "Projeto de Automacao Dennis Fazio Compasso UOL",
